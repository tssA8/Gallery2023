...
import static com.github.cropbitmap.CropViewUtils.scaleBitmapForWidth;

/***
 *   created by zhongrui on 2018/9/11
 */
public class LikeQQCropViewTwo extends LikeQQCropView {
    ...
    public LikeQQCropViewTwo setRadius(float radius) {
        this.radius = radius;
        post(new Runnable() {
            @Override
            public void run() {
    ...
    public LikeQQCropViewTwo setBgColor(int bgColor) {
    ...
    public LikeQQCropViewTwo setBorderColor(@ColorInt int borderColor) {
    ...
    public LikeQQCropViewTwo setMaxScale(float maxScale) {
        if (maxScale < 1) {
            maxScale = 1;
        }
    ...
    public LikeQQCropViewTwo setDoubleClickScale(float doubleClickScale) {
    ...
    public LikeQQCropViewTwo(Context context) {
        super(context);
        initGesture();
        initAttr(null);
    }
    ...
    public LikeQQCropViewTwo(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initGesture();
        initAttr(attrs);
    }

    public LikeQQCropViewTwo(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        }
        ...
        if (showBitmap.getWidth() > showBitmap.getHeight()) {
            Log.d("TAG", "init: ========================111一个扁的图片");
            initScale = getHeight() * 1.0f / showBitmap.getHeight();
            initTranslateY = 0;
            initTranslateX = (getWidth() - showBitmap.getWidth() * initScale) / 2;
        } else {
            Log.d("TAG", "init: ========================222一个高的图片");
            //应该让它的宽度等于圈圈的直径,圈圈的直径应该是getHeight()吧
            initScale = getHeight() * 1.0f / showBitmap.getWidth();
            initTranslateY = (getHeight() - showBitmap.getHeight() * initScale) / 2;
            initTranslateX = (getWidth() - showBitmap.getWidth() * initScale) / 2;
        }
...
//        touchRegion.setPath(bigCirclePath,new Region(0,0,getWidth(),getHeight()));
    ...
    public Bitmap clip() {
        ...
        Bitmap needCropBitmap = Bitmap.createBitmap(showBitmap, (int) rectF.left, Math.max(0, (int) rectF.top), (int) (rectF.right - rectF.left), (int) (rectF.bottom - rectF.top));
...
//                                Log(initScale+"==="+initScale);
    ...
    @Deprecated
    public LikeQQCropViewTwo setBitmap(Bitmap bitmap) {
        showBitmap = bitmap;
        resetBitmap();
        return this;
    }
    ...
    /*******************************************************************************************************/
    public LikeQQCropViewTwo setBitmap(int resId, int reqWidth, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmap(getContext(), resId, reqWidth, reqHeight);
        resetBitmap();
        return this;
    }

    public LikeQQCropViewTwo setBitmap(String pathName, int reqWidth, int reqHeight) {
    ...
    @Deprecated
    public LikeQQCropViewTwo setBitmapToRotate(String pathName, int reqWidth, int reqHeight) {
        //内部已做旋转处理
        showBitmap = CropViewUtils.compressBitmap(pathName, reqWidth, reqHeight);
        resetBitmap();
...
//        }
    ...
    public LikeQQCropViewTwo setBitmap(byte[] data, int offset, int length, int reqWidth, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmap(data, offset, length, reqWidth, reqHeight);
        resetBitmap();
        return this;
    }

    public LikeQQCropViewTwo setBitmap(FileDescriptor fd, Rect outPadding, int reqWidth, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmap(fd, outPadding, reqWidth, reqHeight);
        resetBitmap();
        return this;
    }

    public LikeQQCropViewTwo setBitmap(Resources res, TypedValue value, InputStream is, Rect pad, int reqWidth, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmap(res, value, is, pad, reqWidth, reqHeight);
        resetBitmap();
        return this;
    }

    public LikeQQCropViewTwo setBitmap(InputStream is, Rect outPadding, int reqWidth, int reqHeight) {
    ...
    /*******************************************************************************************************/
    public LikeQQCropViewTwo setBitmapForHeight(int resId, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmapForHeight(getContext(), resId, reqHeight);
        resetBitmap();
        return this;
    }

    public LikeQQCropViewTwo setBitmapForHeight(String pathName, int reqHeight) {
...
//        }
    ...
    public LikeQQCropViewTwo setBitmapForWidth(Bitmap bitmap, int reqWidth) {
        showBitmap = compressBitmapForWidth(bitmap, reqWidth);
        resetBitmap();
        return this;
    }

    public LikeQQCropViewTwo setBitmapForWidth(String pathName, int reqWidth) {
    ...
    //处理旋转
    public LikeQQCropViewTwo setBitmapForWidth(String pathName, int reqWidth, int angle) {
        showBitmap = CropViewUtils.compressBitmapForWidth(pathName, reqWidth);
        showBitmap = rotateBitmap(angle, showBitmap);
        resetBitmap();
        return this;
    }

    @Deprecated
    public LikeQQCropViewTwo setBitmapForWidthToRotate(String pathName, int reqWidth) {
        //内部已做旋转处理
        showBitmap = CropViewUtils.compressBitmapForWidth(pathName, reqWidth);
        resetBitmap();
//        int degree = CropViewUtils.readPictureDegree(pathName);
...
//        }
    ...
    public LikeQQCropViewTwo setBitmapForWidth(byte[] data, int offset, int length, int reqWidth) {
        showBitmap = CropViewUtils.compressBitmapForWidth(data, offset, length, reqWidth);
        resetBitmap();
        return this;
    }

    public LikeQQCropViewTwo setBitmapForWidth(FileDescriptor fd, Rect outPadding, int reqWidth) {
        showBitmap = CropViewUtils.compressBitmapForWidth(fd, outPadding, reqWidth);
        resetBitmap();
        return this;
    }

    public LikeQQCropViewTwo setBitmapForWidth(Resources res, TypedValue value, InputStream is, Rect pad, int reqWidth) {
        showBitmap = CropViewUtils.compressBitmapForWidth(res, value, is, pad, reqWidth);
        resetBitmap();
        return this;
    }

    public LikeQQCropViewTwo setBitmapForWidth(InputStream is, Rect outPadding, int reqWidth) {
    ...
    /*******************************************************************************************************/
    public LikeQQCropViewTwo setBitmapForScale(int resId, int scaleSize) {
        showBitmap = CropViewUtils.compressBitmapForScale(getContext(), resId, scaleSize);
        resetBitmap();
        return this;
    }

    public LikeQQCropViewTwo setBitmapForScale(String pathName, int scaleSize) {
    ...
    @Deprecated
    public LikeQQCropViewTwo setBitmapForScaleToRotate(String pathName, int scaleSize) {
        //内部已做旋转处理
        showBitmap = CropViewUtils.compressBitmapForScale(pathName, scaleSize);
        resetBitmap();
        return this;
    ...
    public LikeQQCropViewTwo setBitmapForScale(byte[] data, int offset, int length, int scaleSize) {
        showBitmap = CropViewUtils.compressBitmapForScale(data, offset, length, scaleSize);
        resetBitmap();
        return this;
    }

    public LikeQQCropViewTwo setBitmapForScale(FileDescriptor fd, Rect outPadding, int scaleSize) {
        showBitmap = CropViewUtils.compressBitmapForScale(fd, outPadding, scaleSize);
        resetBitmap();
        return this;
    }

    public LikeQQCropViewTwo setBitmapForScale(Resources res, TypedValue value, InputStream is, Rect pad, int scaleSize) {
        showBitmap = CropViewUtils.compressBitmapForScale(res, value, is, pad, scaleSize);
        resetBitmap();
        return this;
    }

    public LikeQQCropViewTwo setBitmapForScale(InputStream is, Rect outPadding, int scaleSize) {
    ...
    public static Bitmap compressBitmapForWidth(Bitmap bitmap, int reqWidth) {
        int degree = 0;
        Log.d("compressBitmapForWidth", "AAA_" + reqWidth + " degree : " + degree);
        Bitmap resizedBitmap = Bitmap.createScaledBitmap(bitmap, reqWidth, 1080, true);
        Log.d("compressBitmapForWidth", "AAA_w " + resizedBitmap.getWidth() + " degree : " + degree+ " h : "+resizedBitmap.getHeight());
        return scaleBitmapForWidth(resizedBitmap, reqWidth, degree);
    }
